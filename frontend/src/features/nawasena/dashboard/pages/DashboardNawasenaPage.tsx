...
// Halaman ini KHUSUS area Nawasena (tim teknologi) -- isinya seputar
// data panen & jadwal tanam saja. Berita/UMKM sekarang punya dashboard
// & login sendiri di area Portal (lihat DashboardPortalPage.tsx).

const HERO_STATS = [
  { label: 'Hasil panen', value: '4,2 t', color: 'text-[#a5d876]' },
  { label: 'Musim tanam aktif', value: '3', color: 'text-white' },
  { label: 'Tahapan berjalan', value: '7', color: 'text-white' },
];
...
const QUICK_ACTIONS: QuickAction[] = [
  {
    ...
    sub: 'Musim Juni',
    icon: IconPlant2,
    href: '/nawasena-admin/harvest',
  },
  {
    label: 'Jadwal Tanam',
    sub: '3 musim aktif',
    icon: IconSeeding,
    href: '/nawasena-admin/planting-schedule',
  },
  {
    label: 'Jadwal',
    sub: 'Kelola jadwal lapangan',
    icon: IconCalendarEvent,
    href: '/nawasena-admin/schedule',
  },
];
...
const ACTIVITIES: Activity[] = [
  ...
  {
    label: 'Tahapan musim tanam ditambahkan',
    sub: 'Penyemaian benih – Musim Gadu 2026',
    time: '2h lalu',
  },
  {
    label: 'Jadwal baru ditambahkan',
    sub: 'Pak Sutrisno – Blok A',
    time: '3h lalu',
  },
];
        ...
        <div className="relative flex items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2.5 text-[22px] font-semibold leading-snug text-white">
              Selamat datang kembali, Tim Teknologi
            </h1>
